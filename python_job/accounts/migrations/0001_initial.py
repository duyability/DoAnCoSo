    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hinh', models.ImageField(default='', null=True, upload_to='uploads/User/avatar/%Y/%m/%d/', verbose_name='Avatar ')),
                ('sologan', models.CharField(blank=True, default='', max_length=50, null=True)),
                ('description', models.TextField(blank=True, default='', max_length=300, null=True, verbose_name='Mô tả - giới thiệu về bản thân')),
                ('year_exp', models.CharField(default='', max_length=300, null=True, verbose_name='Số Năm Kinh Nghiệm')),
