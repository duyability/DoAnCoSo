...
class RegisterEmployeeView(CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return render(request, 'tai-khoan/Freelance/dang-ki.html', {'form': form})
...
class RegisterEmployerView(CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return render(request, 'tai-khoan/Nhatuyendung/dang-ki.html', {'form': form})
...
class LoginView(FormView):
    ...
    template_name = 'tai-khoan/login.html'
